...
import com.lzj.common.utils.file.MimeTypeUtils;
import com.lzj.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(ProjectFlowConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
